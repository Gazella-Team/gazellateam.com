...
const caseDataFirst = [
    ...
    {heading:"Planmates", description: "Seamless platform for slot bidding for minecraft servers", image:"/blog-images/how-much-does-an-app-cost/main.webp", link:"/minecraft-buzz-auctions"},
]
