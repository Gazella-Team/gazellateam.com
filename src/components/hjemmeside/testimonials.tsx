            ...
            <div className="w-[90%] mx-auto max-w-[1300px] grid grid-cols-1 gap-24 lg:grid-cols-3 lg:gap-6">
                <div className="shadow-sm text-center flex flex-col justify-between bg-[#fafafa] p-10 px-16 border border-gray-600/10 rounded-2xl">
                    ...
                    <p className="paragraph mb-10">
                        &quot;
                        Fuldkommen perfekt hjemmeside. Jeg har arbejdet sammen med Lasse og hans team da jeg stod og manglede en ny hjemmeside til mit agency. Der er ikke andet at sige end at resultatet er blevet virkelig lækkert og lige hvad jeg søgte. Kan varmt anbefales til alle der leder efter en hjemmeside fra øverste hylde!                        &quot;
                    </p>
