        ...
        <section className="py-24 pt-20">
            <div className="w-[90%] max-w-7xl mx-auto">
                <RevealWild delayTime={0.3}>
                    <h1 className="font-semibold text-main tracking-tight max-w-3xl text-4xl md:text-4xl xl:text-6xl leading-[120%] mb-8">{props.heading}<span className='text-second'>.</span></h1>
                </RevealWild>
