        ...
        <section style={{backgroundImage: `url(${props.imagePath})`}} className={`bg-center relative bg-cover flex flex-col justify-center py-32 text-white`}>
            <div className="w-[90%] flex flex-col gap-10 max-w-[1300px] mx-auto relative z-10">
                <div className="flex items-center gap-3">
                    <Link className="bg-white px-5 py-1.5 rounded-full text-main paragraph font-semibold" href={"/contact"}>4.0 stjerner på Trustpilot</Link>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link className="bg-white px-5 py-1.5 rounded-full text-main paragraph font-semibold" href={"/contact"}>Læs mere</Link>
                </div>
            </div>
