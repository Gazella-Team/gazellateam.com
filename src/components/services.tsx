				...
				<div className="max-w-2xl">
					...
					<Reveal>
						<div className="flex flex-col gap-4">
							...
							<p className="font-light text-[18px] paragraph text-gray-600">
								At have et konverteringsoptimeret setup til din
								webshop er essentielt for optimale resultater.
								Ved at implementere en unik identitet sammen med
								konverteringsoptimerede sider og betalingsflows,
								er vi i stand til at maksimere potentialet i
								enhver webshop.{' '}
							</p>
						</div>
					</Reveal>
