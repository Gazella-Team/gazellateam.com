    ...
    return (
        <section className="py-[100px]">
            <div className="w-[90%] mx-auto max-w-[660px]">
                <Reveal>
                    <div className="border rounded-full px-2 py-1 inline-block mb-10">
                ...
                <Reveal>
                    <h1 className="text-[54px] font-[300] leading-[110%] mb-[50px]">Get a free SEO analysis of your current web-page</h1>
                </Reveal>
                <Reveal>
