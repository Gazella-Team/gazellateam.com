...
const brandsData = [
    {company: "ToolBird", caseDescription: "Planmates is a mobile app, made to make planning new events and plans with your friends easier", caseImage: "/products/centox.svg", tag:["web-app", "design", "frontend"], link: "/work/cases/centox"},
...
export default function Brands() {
    return (
        <section className="py-[100px] pt-[0px]">
            <div className="w-[94%] mx-auto max-w-main grid grid-cols-2 gap-6">
