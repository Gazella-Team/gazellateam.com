			...
			{Array.from({ length: steps }, (_, i) => i + 1).map((item) => (
				<li
					...
					className={cn(
						...
						item < steps &&
							"w-full after:content-[''] after:w-full after:border-main after:border",
				...
				>
					<span
						className={cn(
							'select-none flex items-center justify-center w-10 h-10 bg-main rounded-full lg:h-12 lg:w-12 shrink-0',
							item > step &&
