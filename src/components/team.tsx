    ...
    return (
        <Reveal>
            <Link target="_blank" href={props.Obj.linkedIn} className="flex flex-col gap-6">
                <img onMouseEnter={() => setImageHovered(true)} onMouseLeave={() => setImageHovered(false)}  className="border border-gray-600/10 transition-all" src={imageHovered ? props.Obj.image:props.Obj.image}></img>
                <div>
