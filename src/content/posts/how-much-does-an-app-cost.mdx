...
description: The pricing related to getting an app developed is not static. It can variy from a smaller amount all the way up to plus 6 figures. Throughout this blog 
authors:
    - name: Lasse Osmann
